...
public class NBTCompound implements AbstractNBTCompound {
    ...
    public NBTCompound(@Nullable NBTTagCompound tagCompound) {
        this(null, tagCompound, null, true);
    }

    private NBTCompound(@Nullable String name, @Nullable  NBTTagCompound tagCompound, @Nullable NBTCompound parent, boolean createNewIfNotExist) {
    ...
    public NBTCompound setTagCompound(@NotNull String var, @NotNull NBTTagCompound nbtTagCompound) {
        return set(var, nbtTagCompound);
    }

    public NBTCompound set(@NotNull String var, @NotNull NBTCompound val) {
    ...
    @Override
    public NBTCompound set(@NotNull String var, short val) {
    ...
    @Override
    public AbstractNBTCompound set(@NotNull String var, boolean val) {
    ...
    public NBTCompound getCompoundIfExist(@NotNull String var) {
        return hasKey(var) ? new NBTCompound(var, getTagCompound(var), this, false) : null;
    }
